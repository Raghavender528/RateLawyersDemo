    ...
    <div class="themeoptions-themes">
        <form method="post" action="options.php" id="form-option" class="theme_option_ft">
            <div class="themeoptions-header">
                <div class="logo">
                    <?php $legal_image = get_template_directory_uri() . '/theme-options/images/logo.png';
                    echo "<a href='http://fasterthemes.com/' target='_blank'><img src='" . esc_url($legal_image) . "' alt='" . __('FasterThemes', 'legal') . "' /></a>"; ?>
                </div>
                <div class="header-right">
                    <?php echo "<h1>" . __('Theme Options', 'legal') . "</h1>";
            ...
            <div class="themeoptions-details">
                <div class="themeoptions-options">
                    ...
                    <div class="postbox left-box"> 
                        ...
                        <?php settings_fields('legal_options');
                                ...
                                <div class="faster-inner-tab-group">
                                    <div class="ft-control">
                                        <input id="logo-img" class="upload" type="text" name="legal_theme_options[logo]" 
                                               value="<?php if (!empty($legal_options['logo'])) { echo esc_url($legal_options['logo']); } ?>" placeholder="<?php _e('No file chosen', 'legal'); ?>" />
        ...
        echo ' : 1350px * 539px)'; ?></a> 
                                    <div class="faster-inner-tab-group">
                                        <div class="ft-control">
                                            <input id="slider-img-<?php echo $legal_section_slider; ?>" class="upload" type="text" name="legal_theme_options[slider-img-<?php echo $legal_section_slider; ?>]" 
                                                   value="<?php if (!empty($legal_options['slider-img-' . $legal_section_slider])) { echo esc_url($legal_options['slider-img-' . $legal_section_slider]); } ?>" placeholder="<?php _e('No file chosen', 'legal'); ?>" />
                                            ...
                                            <div class="screenshot" id="slider-img-<?php echo $legal_section_slider; ?>">
                                                <?php if (!empty($legal_options['slider-img-' . $legal_section_slider])) {
                                        ...
                                        <div class="ft-control">
                                            <input type="text" placeholder="<?php
                                                   ...
                                                   echo 'fa-inr )'; ?>" id="faicon-slider-<?php echo $legal_section_slider; ?>" class="of-input" name="legal_theme_options[faicon-slider-<?php echo $legal_section_slider; ?>]" size="32"  value="<?php
                            ...
                            <?php for ($legal_section_fafaicons = 1; $legal_section_fafaicons <= 8; $legal_section_fafaicons++): ?>
                                <div class="section theme-tabs theme-slider-img">
                                    ...
                                    <div class="faster-inner-tab-group">
                                        ...
                                        <div class="ft-control">
                                            <input placeholder="<?php _e('Enter Benefits Title Here', 'legal'); ?>" type="text" maxlength="50" class="of-input" name="legal_theme_options[section-title-<?php echo $legal_section_fafaicons; ?>]" size="32"  value="<?php
                                ...
                                <div class="faster-inner-tab-group">
                                    <div class="ft-control">
                                        <input id="bg-img" class="upload" type="text" name="legal_theme_options[bg-img]" 
                                               value="<?php if (!empty($legal_options['bg-img'])) { echo esc_url($legal_options['bg-img']); } ?>" placeholder="<?php _e('No file chosen', 'legal'); ?>" />
                                        <input  id="upload_image_button" class="upload-button button" type="button" value="<?php _e('Upload', 'legal'); ?>" />
						...
						<div id="options-group-5" class="group legal-inner-tabs fasterthemes-pro-image">
							<a href="https://fasterthemes.com/wordpress-themes/legal" target="_blank">
                                <img src="<?php echo get_template_directory_uri(); ?>/theme-options/images/legal_pro_features.png" style="width:750px;" />
                            </a>
						  </div>
