...
<section class="section-main home-page">
        ...
        <div id="myCarousel" class="carousel slide carousel-fade">
            <div class="carousel-inner">
                ...
                for ($legal_slider = 1; $legal_slider <= 5; $legal_slider++): if (empty($legal_options['slider-img-' . $legal_slider])) {
                    ...
                    if (!empty($legal_options['slider-img-' . $legal_slider])) { ?>  
                        <div class="item <?php if ($legal_slider == 1) { echo'active'; } ?>">
                            ...
                            <div class="banner-inner-content">
                                ...
                                <?php if (!empty($legal_options['slidebuttontext-' . $legal_slider])) { ?>
                                    <div class="banner-button">
                                        <a href="<?php if (!empty($legal_options['slidebuttonlink-' . $legal_slider])) { echo esc_url($legal_options['slidebuttonlink-' . $legal_slider]); } else { echo '#'; } ?>">
    ...
    <div class="home-practise-section">
        <div class="container theme-container">
            ...
            <?php }
            if (!empty($legal_options['benifits-title']) || (function_exists('appointment')) ) { ?>
            ...
            <div class="blur-effect">
                <div class="container theme-container">
                    ...
                    if (!empty($legal_options['bg-btn-title'])) { ?>
                        <div class="banner-button">
                            <a href="<?php if (!empty($legal_options['bg-btn-link'])) { echo esc_url($legal_options['bg-btn-link']); } else { echo "#"; } ?>"><?php echo esc_attr($legal_options['bg-btn-title']); ?></a>
                        </div>
                    <?php } ?>
                </div>
            </div>     
                            ...
                            <div class="col-md-4 col-sm-6 our-latest-box">
                                <div class="latest-blog-img">
                                    <div class="inner-grid">
                                        ...
                                        <div class="post-meta">
                                            <ul>
                                                <?php $legal_author = ucfirst(get_the_author());
