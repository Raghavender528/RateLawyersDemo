...
class legal_recent_widget extends WP_Widget {
    function __construct() {
        ...
        parent::__construct('legal-recent-widget', __('Legal Recent Posts', 'legal'), $legal_widget_ops, $legal_control_ops);
    }
    ...
    function form($legal_instance) {
        ...
        echo ":"; ?>
            ...
            <input id="<?php echo $this->get_field_id('title'); ?>" name="<?php echo $this->get_field_name('title'); ?>" value="<?php if (!empty($legal_instance['title'])) { echo $legal_instance['title']; } ?>" style="width:100%;" type="text" />
        </p>
        <p>
        ...
        echo ":"; ?>
            ...
            <input id="<?php echo $this->get_field_id('noofpost'); ?>" name="<?php echo $this->get_field_name('noofpost'); ?>" value="<?php if (!empty($legal_instance['noofpost'])) { echo $legal_instance['noofpost']; } ?>" size="3" type="text" />
        </p>
        <p>
