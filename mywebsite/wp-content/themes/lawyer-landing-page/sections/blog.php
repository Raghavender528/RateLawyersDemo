    					...
    					<article class="post">
        					<?php if( has_post_thumbnail() ){ ?>
        						<a href="<?php the_permalink(); ?>" class="post-thumbnail">
        						   <?php the_post_thumbnail( 'lawyer-landing-page-blog' ); ?>
        						</a>
        				    <?php }else{ ?>
                                <img src="<?php echo esc_url( get_template_directory_uri() . '/images/blog-fallback.png' ); ?>" alt="<?php the_title_attribute(); ?>" />        
                            <?php } ?>
