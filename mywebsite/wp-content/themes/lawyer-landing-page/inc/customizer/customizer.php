 ...
 */
    ...
    $lawyer_landing_page_settings = array( 'default', 'header', 'home', 'breadcrumb', 'social', 'info' );
...
function lawyer_landing_page_customize_preview_js() {
	wp_enqueue_script( 'lawyer_landing_page_customizer', get_template_directory_uri() . '/js/customizer.js', array( 'customize-preview' ), '20151215', true );
}
